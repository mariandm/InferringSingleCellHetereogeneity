...
function dy = ODE_SEnIV_sink(t,y,params)
...
if params.n==0
    ...
    dy(3) = params.beta*params.eta*I - params.phi*(S+I)*V;
    ...
    dy(params.n+3) = params.beta*(params.n+1)*params.eta*I - params.phi*(S+sum(E)+I)*V;
end
