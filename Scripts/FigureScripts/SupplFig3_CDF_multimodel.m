...
for i=1:4
    ...
    scatter(times,means,'Filled','k','SizeData',40);
    ...
    xlabel(tl,'Time after infection, hr','FontSize',16,'FontName','Latin Modern Sans');
    ylabel(tl,'Proportion of lysed to infected cells','FontSize',16,'FontName','Latin Modern Sans')
end
