...
% Output: ~/Figures/SupplFig4_ProportionInfected.svg
%%
...
for i = 1:numel(replicates)
    ...
    scatter(this_exp(:,1),this_exp(:,4)./this_exp(:,3),'filled',...
        'Marker',markershapes(i)); hold on;
end
...
saveas(gcf,'../../Figures/SupplFig4_ProportionInfected.svg');